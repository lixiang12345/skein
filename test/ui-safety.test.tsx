      ...
      const output = renderToString(
        <>
          ...
          <ContextInspector
            ...
            width={80}
            summary={undefined}
            status={{pressure: 0.25, promptTokens: 125_000, promptSource: 'actual', contextWindowTokens: 500_000, messageCount: 3, activeTokens: 1200, summaryTokens: 0, toolTokens: 40, compactedMessages: 0}}
