...
- Current repository version: `0.3.43`.
...
The latest verified package is `skein-code-cli-0.3.43.tgz`. The verifier writes
its SHA-256 to `artifacts/package/skein-code-cli-0.3.43.tgz.sha256`, and CI
