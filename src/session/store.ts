...
const sessionSchema = z.object({
  ...
  usage: z.object({
    ...
    actualCachedInputTokens: z.number().nonnegative().optional(),
    actualCacheWriteInputTokens: z.number().nonnegative().optional(),
    actualReasoningTokens: z.number().nonnegative().optional(),
